...
const App: React.FC = () => {
  ...
  const RegistrationForm: React.FC<FormProps> = ({ onBack }) => {
    ...
    const payload = {
      //adjust payload keys as per backend requirements
      ID: formData.id,
        ...
        >
          ...
          >
            ...
            <div className="md:col-span-2 text-xs font-bold  tracking-widest opacity-50 border-b border-white/5 pb-2 mt-2">
              For now we let all fields be manually entered, later Application
              ID and EPIC will be auto-generated by backend
            </div>

...
const App = () => {
  ...
  // Handle scroll for navbar styling with performance optimization
  useEffect(() => {
    const handleScroll = () => {
  ...
  return (
    <div
      className={`min-h-screen font-sans antialiased selection:bg-orange-500 selection:text-white transition-colors duration-700 ease-in-out
      ${
        isDarkMode
    ...
    >
      ...
      {/* --- HERO SECTION --- */}
      <main className="relative z-10 pt-40 pb-20 min-h-screen flex flex-col items-center justify-center">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="flex flex-col items-center text-center">
            {/* Live Badge */}
            <div
              className={`animate-fade-in-up flex items-center gap-3 px-4 py-1.5 rounded-full border mb-10 backdrop-blur-md transition-colors duration-300
              ${
                isDarkMode
            ...
            >
              The official digital gateway for the Election Commission of India.
              <span
            ...
            <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
              ...
              >
                ...
                <div className="p-8 md:p-10 flex flex-col h-full items-start text-left">
                  ...
                  >
                    Access digital voter services. Download e-EPIC, register to
                    vote, and view candidate affidavits.
                  </p>
                  ...
                  <div className="mt-auto w-full pt-6 border-t border-dashed border-gray-700/20">
                    ...
                    >
                      ...
                      >
                        ...
                        <SignInButton />
                        {/*<ArrowRight className="w-4 h-4" /> this redirects to same hero page since there is no next page for now so there is no way to sign out */}
                      </span>
                    </button>
                  </div>
                </div>
              ...
              >
                ...
                <div className="p-8 md:p-10 flex flex-col h-full items-start text-left">
                  ...
                  >
                    Secure gateway for Election Officials, BLOs, and Observers.
